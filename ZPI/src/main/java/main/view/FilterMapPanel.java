...
//		initialize();
	...
	public void initialize(){
		...
		freeCheckBox.setBounds(19, 63, 97, 23);
		...
		courseCheckBox.setBounds(118, 63, 117, 23);
		...
		pausedCheckBox.setBounds(19, 89, 97, 23);
		...
		blockedCheckBox.setBounds(118, 89, 117, 23);
		...
		unavalaibleCheckBox.setBounds(19, 115, 97, 23);
		...
		filterDrivers.setBounds(118, 140, 87, 29);
		...
		lblKlienciWgStatusu.setBounds(19, 179, 137, 29);
		add(lblKlienciWgStatusu);
		
		JCheckBox chckbxNewCheckBox = new JCheckBox("oczekujące");
		...
		chckbxNewCheckBox.setBounds(19, 205, 97, 23);
