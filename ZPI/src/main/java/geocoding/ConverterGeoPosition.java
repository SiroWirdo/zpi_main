...
public class ConverterGeoPosition {
	...
	public static AddressInfo addressToAdressInfo(String address) {
		...
		// GeoApiContext().setApiKey(Settings.GOOGLE_API_KEY);
		...
		return addressInfo;
		//
		// GeocodingApiRequest req =
		// GeocodingApi.newRequest(context).address("Wroc³aw");
	...
	public static ParseGeoPoint addressInfoToParseGeoPoint(
			AddressInfo addressInfo) {
		return new ParseGeoPoint(addressInfo.getLatitude(),
				addressInfo.getLongtitude());
	}
}
