...
public class AddUserView extends JFrame{
	...
	public void initialize(){
		...
		userNameTF.setBounds(x+130, y, 100, 20);
		...
		passwordTF.setBounds(x+130, y, 100, 20);
		...
		confirmPasswordTF.setBounds(x+130, y, 100, 20);
		...
		emailTF.setBounds(x + 130, y, 100, 20);
	...
	public String[] getValues(){
		String[] values = {userNameTF.getText(), passwordTF.getText(), confirmPasswordTF.getText(), emailTF.getText()};
		return values;
	}
